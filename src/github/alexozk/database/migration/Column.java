...
public class Column {
    ...
    public static Column fieldToColumn(Table table, Database database, Field field) {
        github.alexozk.database.model.Column col = field.getAnnotation(github.alexozk.database.model.Column.class);

        github.alexozk.database.migration.Column colmig = null;
        if (col.serial()) {
