...
import github.alexozk.database.DatabaseException;
...
public class Model<T extends Model<T>> {
    ...
    public github.alexozk.database.migration.Table migrate() throws SQLException {
